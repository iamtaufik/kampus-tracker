      ...
      <div className="mt-6 mb-4">
        ...
        <div className="w-full">
          ...
          <ul className="flex flex-col gap-4">
            {category === 'Mahasiswa' && data.map((item, index) => <Card item={item} index={index} category="Mahasiswa" searchTerm={debounceValue} />)}
            {category === 'Dosen' && data.map((item, index) => <Card item={item} index={index} category="Dosen" searchTerm={debounceValue} />)}
            {category === 'All' && data.map((item, index) => <Card item={item} index={index} category="All" searchTerm={debounceValue} />)}
          </ul>
        </div>
      </div>
    </div>
